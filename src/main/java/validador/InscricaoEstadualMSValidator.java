...
public class InscricaoEstadualMSValidator {

	public static void isValidInscricaoEstadualMS(String inscricaoEstadual) throws Exception {
		...
		if (!inscricaoEstadual.matches("(28)\\d{7}")) {
